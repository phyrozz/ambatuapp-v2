...
type CommunityVideo = { id: string; title: string; description: string; uploader: string; uploaderId?: string; thumbnailUrl: string; upvotes: number; downvotes: number; commentCount: number };
